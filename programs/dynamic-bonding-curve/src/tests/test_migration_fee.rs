...
use crate::get_liquidity_for_adding_liquidity;
...
proptest! {
    ...
    fn test_damm_v2_protocol_migration_fee(
        ...
        let initial_liquidity = get_liquidity_for_adding_liquidity(migration_base_amount, migration_quote_amount, sqrt_price).unwrap();
        ...
        let excluded_fee_initial_liquidity = get_liquidity_for_adding_liquidity(excluced_fee_migration_base_amount, excluced_fee_migration_quote_amount, sqrt_price).unwrap();
